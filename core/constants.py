...
COMMON_ATTACK_MAPPINGS = {
    "process": {
        ...
        "process_injection": {"technique_id": "T1055", "technique_name": "Process Injection", "tactic": "defense_evasion"},
        ...
        "mshta": {"technique_id": "T1218.005", "technique_name": "Mshta", "tactic": "defense_evasion"},
        "regsvr32": {"technique_id": "T1218.010", "technique_name": "Regsvr32", "tactic": "defense_evasion"},
        "rundll32": {"technique_id": "T1218.011", "technique_name": "Rundll32", "tactic": "defense_evasion"},
    },
    "registry": {
        "run_key": {"technique_id": "T1547.001", "technique_name": "Registry Run Keys / Startup Folder", "tactic": "persistence"},
        "registry_modification": {"technique_id": "T1112", "technique_name": "Modify Registry", "tactic": "defense_evasion"},
    },
    "file": {
        "file_create": {"technique_id": "T1105", "technique_name": "Ingress Tool Transfer", "tactic": "command_and_control"},
        "file_delete": {"technique_id": "T1070.004", "technique_name": "File Deletion", "tactic": "defense_evasion"},
        "masquerading": {"technique_id": "T1036", "technique_name": "Masquerading", "tactic": "defense_evasion"},
    },
    "network": {
        ...
        "ip_connection": {"technique_id": "T1071", "technique_name": "Application Layer Protocol", "tactic": "command_and_control"},
